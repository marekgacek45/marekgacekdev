...
<template>
     <Link :href="route('post.show',post.slug)" as="div" class="lg:col-span-2 flex flex-col justify-start items-start gap-3 group cursor-pointer">
            <!--POST CARD-->
            <div class="w-full max-h-[500px] overflow-hidden group-first:block hidden">
                <img
