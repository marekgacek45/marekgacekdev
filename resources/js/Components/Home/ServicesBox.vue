...
<template>
    <OldSchoolCard title="uslugi" ref="fromBottom">
        <div class="border-x-2 border-black " :class="currentBackground">
            <img :src="currentImage" alt="obrazek przedstawiający pracującego robota" loading="lazy" width="660" height="450" class="w-full h-[400px] sm:h-[450px] object-cover object-center" />
            <!-- <img src="/assets/images/marekgacekdev-30.webp" alt="obrazek przedstawiający pracującego robota" loading="lazy" width="660" height="450" class="w-full h-[400px] sm:h-[450px] object-cover object-center" /> -->
            <div class="px-6 py-10 min-h-[420px] xs:min-h-[350px]  sm:min-h-64   2xl:min-h-50 border-t-2 border-fontDark flex justify-center items-center">
                <p class=" xs:text-lg font-text ">{{ currentText }}</p>
            </div>
        </div>
